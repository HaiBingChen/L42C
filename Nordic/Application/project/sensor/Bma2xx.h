...
*/
#define BMA2x2_WR_FUNC_PTR signed char (* bus_write)(unsigned char, unsigned char , unsigned char *, unsigned char)
...
#define BMA2x2_RD_FUNC_PTR signed char (* bus_read)( unsigned char, unsigned char , unsigned char *,unsigned char)
#define BMA2x2_BRD_FUNC_PTR signed char (* burst_read)(unsigned char, unsigned char, unsigned char *, unsigned int)
...
#define E_SMB_NULL_PTR          (signed char)-127
#define E_COMM_RES              (signed char)-1
#define E_OUT_OF_RANGE          (signed char)-2
#define E_EEPROM_BUSY           (signed char)-3
...
#define E_BMA2x2_NULL_PTR                       (signed char)-127
...
#define E_BMA2x2_OUT_OF_RANGE                      (signed char)-2
