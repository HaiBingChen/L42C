...
#define BLE_UUID_NUS_SERVICE 0x6006 //0x0001       //xs               /**< The UUID of the Nordic UART Service. */
...
typedef void (*ble_nus_data_handler_t) (ble_nus_t * p_nus, uint8_t * p_data, uint16_t length, uint16_t handle);
