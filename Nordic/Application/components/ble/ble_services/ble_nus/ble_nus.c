...
#define BLE_UUID_NUS_TX_CHARACTERISTIC 0x8001 //0x0002           //xs           /**< The UUID of the TX Characteristic. */
#define BLE_UUID_NUS_RX_CHARACTERISTIC 0x8002 //0x0003           //xs           /**< The UUID of the RX Characteristic. */
